...
void Log(wchar_t *wsString, int iLogLevel) {
	Log_nontimestamp(wsString, iLogLevel);
	return;
	...
	fwprintf_s(fp, L"[%02d:%02d:%02d] %s", t.tm_hour, t.tm_min, t.tm_sec,wsString);
	fwprintf_s(stdout, L"[%02d:%02d:%02d] %s", t.tm_hour, t.tm_min, t.tm_sec,wsString);
