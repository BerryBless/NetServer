...
public:
	...
	virtual void Paint_LineMulti();		// 꺾은선 그래프 (선 2개이상)
	virtual void Paint_Pie();			// 원 그래프
	virtual void Paint_Onoff();			// 온오프 토글 보이기
	virtual void Paint_Number();		// 숫자로 출력
