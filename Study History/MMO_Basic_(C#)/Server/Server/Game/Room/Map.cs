...
namespace Server.Game
{
    ...
    public struct Vector2Int
    {
        ...
        public float magnitude { get { return (float)Math.Sqrt(sqrMagnitude); } } // 방향 벡터의 크기
        public int sqrMagnitude { get { return (x * x + y * y); } }

        public int cellDistFromZero { get { return Math.Abs(x) + Math.Abs(y); } } // 우측으로 x 번 위쪽으로 y번 가냐 
    ...
    public class Map
    {
        ...
        public bool CanGo(Vector2Int cellPos, bool checkObjectes = true)
        {
            ...
            return !_collision[y, x] && (!checkObjectes || _objects[y, x] == null);
        }
