...
public:
	...
	// 
	// 
	// Parameters: 출력할곳의 HWND
	// Return : 없음
	//////////////////////////////////////////////////////////////////////////
	void SetPaint(HWND hWnd);
...
#pragma endregion
	...
	//////////////////////////////////////////////////////////////////////////
	void DisplayTree();
	void DisplayTree(int iWidth);

	//////////////////////////////////////////////////////////////////////////
	// 노드 출력
	// 
	// 
	// Parameters: (pNode, oX, oY, &rX, &w)
	// 	   pNode = 현재 출력할 노드
	// 	   oX, oY = 오프셋 (x, y)
	// 	   rX	= 현재 노드가 출력될 X좌표
	// 	   w	= 현재 트리의 너비
	// Return: (void) 없음.
	//////////////////////////////////////////////////////////////////////////
	void DrawTree(stNODE *pNode, int oX, int oY, int &rX, int &w);

	// sw : 시작 x좌표(너비)
	// se : 끝 X좌표(너비
	// oY : 깊이의 높이
	void DrawTree(stNODE *pNode, int sW, int eW, int oY);
	...
	// Return: (void) 없음.
	//////////////////////////////////////////////////////////////////////////
	void Rotate_Left(int iData);
	void Rotate_Left(stNODE *pPivotNode);	// 왼쪽으로
	void Rotate_Right(int iData);	// 오른쪽으로
