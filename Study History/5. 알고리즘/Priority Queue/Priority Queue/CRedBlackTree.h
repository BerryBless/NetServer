...
#pragma region 삽입삭제
	...
	//////////////////////////////////////////////////////////////////////////
	bool InsertNode(long long Key, long long Data = 0);
...
#pragma endregion
	...
	// Return: (void) 없음.
	//////////////////////////////////////////////////////////////////////////
	void Rotate_Left(long long Key);
	void Rotate_Left(stNODE *pPivotNode);	// 왼쪽으로
	void Rotate_Right(long long Key);	// 오른쪽으로
