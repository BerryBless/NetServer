...
int RingBuffer::Enqueue(const unsigned char *pData, int iSize) {
...
int RingBuffer::Dequeue(unsigned char *pDest, int iSize) {
...
int RingBuffer::Peek(unsigned char *pDest, int iSize) {
...
void RingBuffer::PrintfInfo(void) {
...
void RingBuffer::Lock(bool bReadonly) {
	if (bReadonly == true) {
		// 읽기 전용
...
void RingBuffer::Unlock(bool bReadonly) {
	if (bReadonly == true) {
		// 읽기 전용
