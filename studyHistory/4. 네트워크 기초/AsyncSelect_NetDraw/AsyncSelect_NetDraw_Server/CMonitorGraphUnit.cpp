...
LRESULT CALLBACK  CMonitorGraphUnit::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	case WM_PAINT:
		...
		if (pThis != NULL) {
			...
			case CMonitorGraphUnit::TYPE::LINE_MULTI:
				pThis->Paint_LineMulti();
				break;

			case CMonitorGraphUnit::TYPE::PIE:
				pThis->Paint_Pie();
				break;

			case CMonitorGraphUnit::TYPE::ONOFF:
				pThis->Paint_Onoff();
				break;

			case CMonitorGraphUnit::TYPE::NUMBER:
				pThis->Paint_Number();
				break;
...
void CMonitorGraphUnit::Paint_LineMulti() {}
void CMonitorGraphUnit::Paint_Pie() {}
void CMonitorGraphUnit::Paint_Onoff() {}
void CMonitorGraphUnit::Paint_Number() {}
